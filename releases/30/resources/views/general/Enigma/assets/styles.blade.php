...
DIV  {
...
#enigmaWrapper {
  background: url("./../images-enigma/wood-board-h.jpg");
  text-align: center;
  width:720px;
  height: 790px;
  ...
  background-size: 100%;
  background-image: url("./../images-enigma/metallic-texture.jpg");
  width: 100%;
  height: 100%;
  border-radius: 8px;
 }
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#000000', endColorstr='#161616',GradientType=1 );
 ...
 .page1 {
  background-image: url("./../images-enigma/enigma-book.png");
 }
 .page2 {
  background-image: url("./../images-enigma/enigma-book2.png");
 }
...
#codebook {
  background-size: 100%;
  background-image: url("./../images-enigma/enigma-paper.png");
  font-family: times new roman;
  width:700px;
  height: 1009px;
  margin: 30px auto;  
